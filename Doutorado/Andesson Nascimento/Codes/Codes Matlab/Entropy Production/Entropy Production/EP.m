...
%plot(vect,s_lb,'LineWidth',2,'DisplayName','Lower');
%hold on;
plot(vect,s_ub,'LineWidth',2,'DisplayName','upper', 'Marker', 'x');
hold on;
plot(vect,s_exact_min,'Linewidth',2)%,'DisplayName','exact')
hold off;
set(gca, 'FontSize', 14);
%legend('Location', 'best');
xlabel('t','FontSize',16);
ylabel('$s(\frac{2}{\pi}\mathcal{L})$', 'Interpreter', 'latex','FontSize',16)
grid on;
