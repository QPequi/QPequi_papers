...
l=0
for l in range(len(EY)):
    j = 0
    for j in range(len(T)):
       # Elementos
       A[j,l] = raz_Q[j,l]*d1_inv[j,l]*d2_g11[j,l] - \
           d1_inv[j,l]*d1_g22[j,l] + \
           inv_sq[j,l]*d1_raz[j,l]*d2_g11[j,l] + \
           inv_sq[j,l]*raz_Q[j,l]*D12_g11[j,l] - \
           inv_sq[j,l]*D11_g22[j,l]  
       B[j,l] = 2*d2_inv[j,l]*d1_g12[j,l] - \
           d2_inv[j,l]*d2_g11[j,l] - \
           raz_Q[j,l]*d2_inv[j,l]*d1_g11[j,l] + \
           2*inv_sq[j,l]*D21_g12[j,l] - \
           inv_sq[j,l]*D22_g11[j,l] - \
           inv_sq[j,l]*d2_raz[j,l]*d1_g11[j,l] - \
           inv_sq[j,l]*raz_Q[j,l]*D21_g11[j,l]                
       R[j,l] = inv_sq[j,l]*(A[j,l]+B[j,l])
       j = j+1
    l = l+1
