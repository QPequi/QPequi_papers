...
RFN = np.zeros(len(vect)) #Rate Function * ll
RF = np.zeros(len(vect)) #Rate Function
DEP = np.zeros(len(vect)) #Variation Entropy Production
DEPN = np.zeros(len(vect)) #Variation Entropy Production
...
for tt in range(len(vect)):
    ...
    TAEP[tt] = (1/np.max(vect))*np.trapz(EP1, vect)
...
ax[1][0].plot(vect,EP1,label='Entropy Production (1 termo)') # 3º grafico
ax[1][0].plot(vect,DEPN,label='Variation of EP(x0,1)') # 3º grafico
#ax[1][0].plot(vect,EP2,label='Entropy Production (2 termos)')
#ax[1][0].plot(vect,EP3,label='Entropy Production (3 termos)')
#ax[1][0].plot(vect,EP4,label='Entropy Production (4 termos)')
#ax[1][0].plot(vect,EP,label='Entropy Production (5 termos)') 
ax[1][0].legend()
ax[1][0].grid()

ax[1][1].plot(vect,TAEP,label='Variation of EP (1 termo)') # 4º grafico
ax[1][1].legend()
ax[1][1].grid()
